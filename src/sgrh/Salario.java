...
public class Salario {
    ...
    public Salario(){
     ...
     public float salarioPres () {
        dias=vv.validarInt("Introduza o numero de dias em que se faz presente na empresa: (1 - 22) ", 1, 22);
        salario=1100*dias;
        return salario;
    }
     public float salarioServ (){
        int nrsp;
        dias=vv.validarInt("Introduza o numero de dias em que prestou servicos na empresa:(1 - 22) ", 1, 22);
        nrsp=vv.validarInt("Introduza o numero de servicos prestados: (1 - 10)",1,10);
     ...
     public float salarioTemp () {
        ...
        dias=vv.validarInt("Introduza o numero de dias em que presta servicos temporarios na empresa:(1 - 22)", 1, 22);
